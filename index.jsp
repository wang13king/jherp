...
<% if(null!=configMap && null!=configMap.get("iconFile")){
	...
	<%	
		...
		<title><%-- <%=AppUtil.getSystemName()%> --%>业务系统</title>
        <!--不能延迟加载-->
		...
		<script type="text/javascript" src="<%=basePath%>/js/p2p/materials/P2pFileUpload.js"></script>
		<script type="text/javascript" src="<%=basePath%>/js/p2p/materials/P2pMaterialsDownLoad.js"></script>
		...
		<script type="text/javascript" src="<%=basePath%>/js/creditFlow/financingAgency/business/PlBusinessDirProKeepForm.js"></script>
		
		<script type="text/javascript" src="<%=basePath%>/js/creditFlow/guarantee/materials/SlEnterPriseProcreditMaterialsView.js"></script>
		<script type="text/javascript" src="<%=basePath%>/js/p2p/materials/P2pShowProcreditMaterialsView.js"></script>
	...
	<body oncontextmenu="return false">
        <div class="header" id="app-header">
			<div class="header_left">
				<div class="logo">
							<img src="images/imagesteam/logo-new.png" />
				</div>
