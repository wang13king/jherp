	        ...
	        jStore_third = new Ext.data.Store({
				...
				this.topbar = new Ext.Toolbar({
						items : [{
									...
									text : this.isHidden?'查看存管账户保证' : '编辑第三方保证',
									xtype : 'button',
									scope:this,
					...
					listeners :{
						afteredit : function(e){
							if(e.record.data['contractId']== null||e.record.data['contractId']== ''){
								Ext.ux.Toast.msg('操作信息','请先生成存管账户保证合同！');
								jStore_third.reload();
							}else{
                        ...
                        {iconCls : 'btn-save',text:"确定",hidden:edit,handler:function(){
				    			  ...
				    			  success : function(form, action) {
    				                            ...
    				                            if(xx=="{success:true,msg:false}"){
    				                            	Ext.ux.Toast.msg('操作信息','该企业存管账户保证已存在，请重新添加');
    				                            	...
    				                            	Ext.ux.Toast.msg('操作信息','企业存管账户保证不能添加自己，请重新添加');
    				                            	 ...
    				                            	 Ext.ux.Toast.msg('操作信息', '修改企业存管账户保证成功!');
		                    ...
		                    {iconCls : 'btn-save',text:"确定",hidden:edit,handler:function(){
		                        	 person.getForm().submit({
						    			  ...
						    			  success : function(form, action) {
		                        	    	 	var xx=action.response.responseText.toString().trim();
					                            if(xx=="{success:true,msg:false}"){
					                            	Ext.ux.Toast.msg('操作信息','该个人存管账户保证已存在，请重新添加');
					                            	...
					                            	Ext.ux.Toast.msg('操作信息','个人存管账户保证不能添加自己，请重新添加');
					    			  ...
					    			  success : function(form, action) {
				                            ...
				                            if(xx=="{success:true,msg:false}"){
				                            	...
				                            	Ext.ux.Toast.msg('操作信息','企业存管账户保证不能添加自己，请重新添加');
				                            	 ...
				                            	 Ext.ux.Toast.msg('操作信息', '添加企业存管账户保证成功!');
					    			  ...
					    			  success : function(form, action) {
				                            ...
				                            if(xx=="{success:true,msg:false}"){
				                            	...
				                            	Ext.ux.Toast.msg('操作信息','个人存管账户保证不能添加自己，请重新添加');
				                            	 ...
				                            	 Ext.ux.Toast.msg('操作信息', '添加个人存管账户保证成功!');
				                            	 this.jStore_third.reload();
					    			             _window.close(); 
				                            }
						...
						if (btn == "yes") {
							...
							for ( var i = 0; i < s.length; i++) {
								...
								if(row.data.categoryId!=''){
									Ext.Msg.alert('状态','请先删除相应的存管账户保证对应的合同');
									return;
								}
								string=string+str+"@";
						    }
