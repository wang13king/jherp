...
//PersonFianceAccount.js
PersonFianceAccount = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		PersonFianceAccount.superclass.constructor.call(this, {
					id : 'PersonFianceAccount',
					title : '资金账户管理',
					region : 'center',
					layout : 'border',
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			...
			plugins : [summary],
			url : __ctxPath
					+ "/creditFlow/customer/person/fianceAccountListPerson.do?isAll="
							+ isGranted('_detail_sygrkh_zjzh'),
			fields : [{
						name : 'id',
						type : 'int'
					}, 
