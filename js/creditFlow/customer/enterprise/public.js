...
//										readOnly : this.isRead,
							...
							items : [{
								...
								items : [{
										...
										scope:this,
										html : isReadOnly==false?'营业执照副本&nbsp;&nbsp;&nbsp;<a href="#"   onClick =uploadPhotoBtnEnterprise(\'营业执照副本\',\'cs_enterprise_zzjgdmz\',\'yingyezhizhao\',\'enterpriseYyzzId\',\''+winId+'\')>上传</a>&nbsp;&nbsp;&nbsp;<a href="#" onClick =delePhotoFile_new(\'enterpriseYyzzId\',\'yingyezhizhao\',\''+winId+'\')>删除</a>':'营业执照副本'
									},{
										name:'yingyezhizhao',
										xtype :'label',
								...
								items : [{
										xtype :'label',
										style :'padding-left :10px',
										html : isReadOnly==false?'组织机构代码证&nbsp;&nbsp;&nbsp;<a href="#" onClick =uploadPhotoBtnEnterprise(\'组织机构代码证\',\'cs_enterprise_zzjgdmz\',\'zhuzhijigou\',\'enterpriseZzjgId\',\''+winId+'\')>上传</a>&nbsp;&nbsp;&nbsp;<a href="#" onClick =delePhotoFile_new(\'enterpriseZzjgId\',\'zhuzhijigou\',\''+winId+'\')>删除</a>':'组织机构代码证'
									},{
										name:"zhuzhijigou",
										xtype :'label',
										html : function(){	
								...
								items : [{
										xtype :'label',
										style :'padding-left :10px',
										html : isReadOnly==false?'税务证扫描件&nbsp;&nbsp;&nbsp;<a href="#" onClick =uploadPhotoBtnEnterprise(\'税务证扫描件\',\'cs_enterprise_gsdjz\',\'guoshuidengji\',\'enterpriseGsdjzId\',\''+winId+'\')>上传</a>&nbsp;&nbsp;&nbsp;<a href="#" onClick =delePhotoFile_new(\'enterpriseGsdjzId\',\'guoshuidengji\',\''+winId+'\')>删除</a>':'税务证扫描件'
									},{
										name:'guoshuidengji',
										xtype :'label',
										html : function(){
								...
								items : [{
										xtype :'label',
										style :'padding-left :10px',
										html : isReadOnly==false?'贷款卡扫描件&nbsp;&nbsp;&nbsp;<a href="#" onClick =uploadPhotoBtnEnterprise(\'贷款卡扫描件\',\'cs_enterprise_dsdjz\',\'dishuidengji\',\'enterpriseDsdjId\',\''+winId+'\')>上传</a>&nbsp;&nbsp;&nbsp;<a href="#" onClick =delePhotoFile_new(\'enterpriseDsdjId\',\'dishuidengji\',\''+winId+'\')>删除</a>':'贷款卡扫描件'
									},{
										name:'dishuidengji',
										xtype :'label',
										html : function(){	
									...
									items : [{
										...
										onTriggerClick : function(com) {
										   var amselectLegalperson1 = function(obj) {
												...
												var urls=getRootPath()+ '/images/nopic.jpg';
												var personSFZSId=obj.personSFZSId;
												var personSFZSUrl=obj.personSFZSUrl;
												if(null!=personSFZSId && null!=personSFZSUrl && ""!=personSFZSId && ""!=personSFZSUrl){
													panel_add.getCmpByName('personSFZSId').setValue(personSFZSId);
												    urls=getRootPath()+"/"+personSFZSUrl;
												}
											    ...
											    var display = panel_add.getCmpByName("shenfenzheng-sc");
												display.setText('<div style="width:144px; height:84px; margin:10px 0px 0px 10px; padding:1px 1px 1px 1px;"><img src="'+urls+'" width =140 height=80/></div>',false);
												
											    
												display = panel_add.getCmpByName("shenfenzheng-z");
										...
										xtype : 'hidden'
													...
													xtype : 'hidden',
													name : 'personSFZSId',
													value : person==null?null:person.personSFZSId
												  },{
												xtype : 'hidden',
												name : 'personSFZZId',
