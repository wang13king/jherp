	...
	initUIComponents : function() {
		...
		this.store = new Ext.data.JsonStore({
			...
			fields : [{name:'truename'},{name : 'recommended'},{name:'keystr'},{name:'investDate'},
					  ...
					  {name:'twoRoleName'},{name:'secondRecommended'},{name:'secondPlainpassword'} ,{name:'recommended1'},{name:'plainpassword1'} ]
		});
		...
		this.centerPanel = new HT.GridPanel({
			...
			columns : [{
				...
				align:'center',
				sortable : true,
				dataIndex : 'plainpassword1'
			},{
				header : this.type=='one'?"推荐人":'推荐人',
				width : 100,
				align:'center',
				sortable : true,
				dataIndex : 'recommended'
			},{
				header : this.type=='one'?"推荐码":"推荐码",
				width : 100,
				align:'center',
				sortable : true,
