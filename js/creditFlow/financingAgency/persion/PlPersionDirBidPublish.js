...
PlPersionDirBidPublish = Ext.extend(Ext.Panel, {
	...
	constructor : function(_cfg) {
		...
		PlPersionDirBidPublish.superclass.constructor.call(this, {
					id : 'PlPersionDirBidPublish_'+this.Q_proType_S_EQ+this.Q_state_N_EQ+this.buttonType+this.subType,
					layout : 'border',
	...
	initUIComponents : function() {
		...
		this.topbar = new Ext.Toolbar({
					items : [{
								...
								hidden:!this.Q_state_N_EQ==7,
								scope : this,
								handler : this.uploadCon
							}]
				});
        var flag=this.Q_state_N_EQ==21 || this.Q_state_N_EQ==22 ||this.Q_state_N_EQ==23;
		 var url=__ctxPath+ "/creditFlow/financingAgency/listPlBidPlan.do?Q_proType_S_EQ="+this.Q_proType_S_EQ+"&Q_state_N_EQ="+(flag?1:this.Q_state_N_EQ)+"&flag="+this.Q_state_N_EQ+"&Q_plBiddingType.biddingTypeId_L_LT=3"+this.querysql;
		...
		this.gridPanel = new HT.GridPanel({
			region : 'center',
			tbar : this.isToolBar?null:this.topbar,
			id : 'PlPersionDirBidPublishGrid'+this.Q_proType_S_EQ+this.Q_state_N_EQ+this.buttonType,
			url : url,
			...
			fields : [{
					...
					'bidStartTime','prepareSellTime', 'publishSingeTime', 'bidEndTime','bpPersionDirPro.proId','bpPersionDirPro.moneyPlanId','proType',
	...
	outToExcel:function(){debugger
		...
		+"&Q_bidProNumber_S_LK="+bidNumber+"&publishSingeTime_GE="+startDate1+"&publishSingeTime_LE="+startDate2+"&bidEndTime_GE="+endDate1+"&bidEndTime_LE="+endDate2+"&Q_bidMoney_BD_GE="+bidMoney1+"&Q_bidMoney_BD_LE="+bidMoney2+"&Q_bpPersionDirPro.loanId_NOTNULL"
,'_blank');
