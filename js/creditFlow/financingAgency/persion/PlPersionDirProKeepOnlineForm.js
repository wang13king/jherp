 ...
 * @author
 * @createtime
 * @class PlPersionDirProKeepOnlineForm
 * @extends Ext.Window
 * @description PlOrProPack表单
 * @company 互融软件
 */
PlPersionDirProKeepOnlineForm = Ext.extend(Ext.Window, {
	...
	constructor : function(_cfg) {
		...
		PlPersionDirProKeepOnlineForm.superclass.constructor.call(this, {
					id : 'PlPersionDirProKeepOnlineFormWin',
					layout : 'fit',
	...
	initUIComponents : function() {
		...
		var proLevelIdComboBox = new Ext.form.ComboBox({
			...
			this.P2POnlineUploadView = new P2POnlineUploadView(
				{
					userId : this.userId,
		...
		this.P2pShowOnlineMaterialsView = new P2pShowOnlineMaterialsView(
				{
					projectId : this.record.data.proId,
					businessType : this.businessType,
					isHiddenEdit : false,
		...
		this.formPanel = new Ext.form.FormPanel({
			...
			items : [{
						...
						items : [this.P2POnlineUploadView]
					}, {
						xtype : 'fieldset',
						collapsible : true,
						autoHeight : true,
						...
						items : [this.P2pShowOnlineMaterialsView]
					}, /*{
						xtype : 'fieldset',
						autoHeight : true,
						collapsible : true,
