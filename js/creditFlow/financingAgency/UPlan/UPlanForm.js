				...
				items : [{
					...
					anchor : "100%"
						...
						items : [{
									xtype : "combo",
									anchor : "100%",
									hiddenName : "plManageMoneyPlan.parentLiveCity",
									displayField : 'itemName',
									valueField : 'itemId',
									allowBlank : false,
									triggerAction : 'all',
									...
									listeners : {
										...
										var opr_obj = this.getCmpByName('plManageMoneyPlan.proArea')
										opr_obj.clearValue();
						...
						items : [{
										...
										allowBlank : false,
										anchor : "100%",
										hiddenName : "plManageMoneyPlan.proArea",
										displayField : 'itemName',
										valueField : 'itemId',
										triggerAction : 'all',
										readOnly : this.isAllReadOnly,
					 ...
					 //	Ext.getCmp("proArea").setValue(result.data.proAreaName);
					 	...
					 	//
										...
										function test(r) {
											...
											opr_obj.setValue(result.data.plManageMoneyPlan.proArea);        
         									opr_obj.setRawValue(result.data.plManageMoneyPlan.proAreaName);  
