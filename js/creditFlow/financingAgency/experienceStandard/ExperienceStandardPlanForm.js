				...
				items : [{
							...
							items : [{
										...
										listeners : {
											...
											'change' : function(nf){
												...
												dayRate.setValue(nf.getValue()/365)
											}
										}
									}]
					    },{
							...
							items : [{
										...
										anchor : '100%',
											...
											var sumMoney=Ext.getCmp('sumMoney').getValue();
											/*	var startMoney=this.getCmpByName('plManageMoneyPlan.startMoney').getValue();
												...
												if(sumMoney<startMoney){
													Ext.getCmp('sumMoney').setValue(null);
													Ext.Msg.alert('操作信息','<font color=red>“本次招标金额”不能小于“投资起点金额”！<font>')
													return ;
												}
											}
										}
							...
							items : [{
										...
										listeners : {
											...
											/*	var startMoney=this.getCmpByName('plManageMoneyPlan.startMoney').getValue();
												var limitMoney=this.getCmpByName('plManageMoneyPlan.limitMoney').getValue();*/
												if(sumMoney<startMoney){
													Ext.getCmp('startMoney').setValue(null);
													Ext.Msg.alert('操作信息','<font color=red>“投资起点金额”不能大于“本次招标金额”！<font>')
													return ;
												}
											}
										}
