	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			...
			fields : [{
					...
					'bidMoney', 'loanLife', 'bidTime', 'createTime','loanEndTime',
					'updateTime', 'publishOrMoney', 'publishOrNum', 'rate','residueMoney','payAcctualType','schemeStat','keepStat'],
			columns : [{
						header : 'bdirProId',
						align:'center',
						dataIndex : 'bdirProId',
				...
				success : function(response,request) {
					...
					if(obj.success){
						new PlDirBidListForm({
							...
							loanEndTime:record.data.loanEndTime
						}).show();
					}else{
