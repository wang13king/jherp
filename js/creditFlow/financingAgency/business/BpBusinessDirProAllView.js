BpBusinessDirProAllView = Ext.extend(Ext.Panel, {
	/*
	...
	constructor : function(_cfg) {
		...
		// 调用父类构造
		BpBusinessDirProAllView.superclass.constructor.call(this, {
					id : 'BpBusinessDirProAllView'+this.managerType ,
					title : '全部项目',
					region : 'center',
					layout : 'border',
	...
	proKeep : function() {
		...
		if (selectRs.length == 0) {
			...
			/*if(record.data.keepStat==1 && isGranted('businessDirProKeep')==false){
