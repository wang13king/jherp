 ...
 * @company 智维软件
 */
PlDirBidListForm = Ext.extend(Ext.Window, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
		PlDirBidListForm.superclass.constructor.call(this, {
					id : 'PlDirBidListForm',
					layout : 'border',
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			...
			url : __ctxPath
					+ "/creditFlow/financingAgency/listPlBidPlan.do?Q_bpBusinessDirPro.bdirProId_L_EQ=" +this.bdirProId+"&Q_proType_S_EQ="+this.proType,
			fields : [{
						name : 'bidId',
						type : 'int'
					},{
					...
					'start', 'startInterestType', 'bidStartTime',
	...
	startRs:function(){
		...
		Ext.Ajax.request( {
			...
			success : function(response) {
					//gridPanel.getStore().reload()PlDirBidListForm
					var win = Ext.getCmp('PlDirBidListForm');
					win.close();
					Ext.ux.Toast.msg('提示','招标成功!');
