 ...
 * @company 智维软件
 */
PlBusinessDirPlanForm = Ext.extend(Ext.Window, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
		PlBusinessDirPlanForm.superclass.constructor.call(this, {
					id : 'PlBusinessDirPlanFormWin',
					layout : 'fit',
...
Ext.apply(Ext.form.VTypes, {  
		...
		if (this.bdirProId != null && this.bdirProId != 'undefined') {
		    ...
		    Ext.Ajax.request({
				url : __ctxPath
							+ '/creditFlow/financingAgency/business/getBidInfoBpBusinessDirPro.do?bdirProId='
							+ this.bdirProId,
				method:"post",
				scope : this,
				success:function(response,opts){
					...
					Ext.getCmp('loanProNumber').setValue(data.proNumber);
	...
	save : function() {
		...
		$postForm({
			...
			callback : function(fp, action) {
				...
				Ext.Msg.alert('操作信息',action.result.msg);
				}
				this.close();
			}
		});
