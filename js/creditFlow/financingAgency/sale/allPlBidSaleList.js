 ...
 * @company 智维软件
 */
allPlBidSaleList = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
		allPlBidSaleList.superclass.constructor.call(this, {
					id : 'allPlBidSaleList',
					title:"全部债权查询",
					layout : 'border',
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			...
			plugins : [summary],
			// 使用RowActions
			id : 'allPlBidSaleListGridPanel',
			url : __ctxPath
					+ "/creditFlow/financingAgency/listPlBidSale.do?listtype=all",
			fields : [{
						name : 'id',
						type : 'int'
