 ...
 * @company 智维软件
 */
ingTransferList = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
		ingTransferList.superclass.constructor.call(this, {
					id : 'ingTransferList',
					title:"正在交易债权查询",
					layout : 'border',
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			...
			// 使用RowActions
			plugins : [summary],
			id : 'PlBidSaleListgrid3',
			url : __ctxPath
					+ "/creditFlow/financingAgency/listPlBidSale.do?listtype=ingTransferList",
			fields : [{
						name : 'id',
						type : 'int'
					}, 'outCustName','inCustName','bidProName', 'yearAccrualRate', 'intentDate', 'saleMoney','saleSuccessTime','transferFee',
					'changeMoneyRate', 'changeMoneyType','changeMoney','saleStartTime', 'saleCloseTime','saleDealTime', 'sumMoney','changeMoney','saleDealTime'],
			columns : [{
						header : 'id',
						align:'center',
						dataIndex : 'id',
