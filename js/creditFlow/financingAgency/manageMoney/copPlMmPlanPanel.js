 ...
 * @extends Ext.Panel
 */
copPlMmPlanPanel = Ext.extend(Ext.Panel, {
	layout : 'anchor',
	anchor : '100%',
	companyHidden : false,
	constructor : function(_cfg) {
        ...
        debugger;
		copPlMmPlanPanel.superclass.constructor.call(this, {
			layout : 'column',
			defaults : {
				anchor : '96%',
				labelWidth : 80,
...
//								id : 'accountTypeid',
							...
							items : [{
								...
								items : [{
									...
									listeners : {
										...
										check : function(obj, checked) {
											var flag = Ext.getCmp("meiqihkrq1"+this.projectId).getValue();
											if (flag == true && !this.isBuyApply) {
												this.getCmpByName('plManageMoneyPlan.isStartDatePay').setValue("1");
												this.getCmpByName('plManageMoneyPlan.payintentPerioDate'+this.projectId).setDisabled(false);
											}
										}
									}
								...
								items : [{
									...
									id : "plManageMoneyPlan.payintentPerioDate"+this.projectId,
									xtype : 'combo',
									mode : 'local',
									disabled : true,
									displayField : 'name',
								...
								items : [{
									...
									listeners : {
										scope : this,
										check : function(obj, checked) {
											var flag = Ext.getCmp("meiqihkrq2"+this.projectId)
													.getValue();
											if (flag == true) {
												this.getCmpByName('plManageMoneyPlan.isStartDatePay').setValue("2");
												this.getCmpByName('plManageMoneyPlan.payintentPerioDate'+this.projectId).setValue(null);
												this.getCmpByName('plManageMoneyPlan.payintentPerioDate'+this.projectId).setDisabled(true);
											}
										}
									}
							...
							items : [{
								...
								items : [{
									...
									listeners : {
										...
										check : function(obj, checked) {
											debugger;
											var flag = Ext.getCmp("jixizq1"+this.projectId).getValue();
											if (flag == true) {
								...
								items : [{
									...
									listeners : {
										scope : this,
										check : function(obj, checked) {
											var flag = Ext.getCmp("jixizq2"+this.projectId).getValue();
//											var flag = this.getCmpByName('q2');
											if (flag == true) {
			...
			this.loadData({
				...
				success : function(response, obj) {
					...
					if(result.data.plManageMoneyPlan.isStartDatePay == 1){
						Ext.getCmp("meiqihkrq1"+this.projectId).setValue(true);
					}
					if(result.data.plManageMoneyPlan.payaccrualType == 'dayPay'){
						Ext.getCmp("jixizq1"+this.projectId).setValue(true);
//						this.getCmpByName('q1').setValue(true);
					}
				}
			});
		}
			...
			items : [{
				...
				items : [/*
						...
						/*		var s = dtstr.split("-");
							   ...
							   if(payType=='monthPay'){
								    ...
								    if( (dt.getYear()*12+dt.getMonth()) > (yy*12+mm + n) )
									 ...
									 Ext.getCmp("plMmOrderInfo.endinInterestTime"+this.projectId).setValue(yesterday);
					...
					items : [{
								...
								id : 'plMmOrderInfo.endinInterestTime'+this.projectId,
								readOnly : true,
								xtype : 'datefield',
								allowBlank : this.hiddenInterest ? true : false,
								format : 'Y-m-d',
