 ...
 */
FinancialProductsModule = Ext.extend(Ext.Panel, {
	panel:null,
	url:'',
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		FinancialProductsModule.superclass.constructor.call(this, {
			id : 'FinancialProductsModule'+this.reportKey,
			title : this.title,
			layout : 'border',
	...
	initUIComponents : function() {
		...
		searchPanel = new HT.SearchPanel({
			id : 'FinancialProducts' + reportKey,
			layout : 'column',
			region : 'north',
			height : 20,
			anchor : '100%',
		...
		debugger
		this.panel=Ext.getCmp('FinancialProducts'+reportKey);
		this.url=__ctxPath + '/system/myReportPlmmInfoWealthReport.do';
