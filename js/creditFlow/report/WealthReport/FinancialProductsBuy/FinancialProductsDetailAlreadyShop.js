 ...
 */
FinancialProductsDetailAlreadyShop = Ext.extend(Ext.Panel, {
	panel:null,
	url:'',
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		FinancialProductsDetailAlreadyShop.superclass.constructor.call(this, {
			id : 'FinancialProductsDetailAlreadyShop'+this.reportKey,
			title : this.title,
			layout : 'border',
	...
	initUIComponents : function() {
					...
					onTriggerClick : function() {
						...
						var EnterpriseNameStockUpdateNew = function(obj) {
							if (null != obj.orgName && "" != obj.orgName){
								...
								Ext.getCmp('departMentName_EQ3').setValue(obj.orgName);
							}
						}
		...
		this.url=__ctxPath + '/system/reportPlmmInfoAlreadyShopWealthReport.do';
