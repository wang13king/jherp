 ...
 * @company 智维软件
 */
selectAccountlForm = function(funname,parent){
	...
	var gridPanel = new HT.GridPanel({
					...
					url : __ctxPath + "/creditFlow/finance/selectlistSlBankAccount.do",
					baseParams :{
					start : 0,
					limit : 100
					...
					fields : [{
							...
							'account', 'rawMoney', 'finalMoney', 'recordTimeString','sumbankname'],
					columns : [{
							...
							listeners:{
						    	'rowdblclick' : function(grid,rowIndex,e) {		
	                                grid.getSelectionModel().each(function(rec) {debugger
	                               		funname(rec.data.account,rec.data.bankName,rec.data.name,rec.data.bankAccountId,rec.data.finalMoney,rec.data.bankName,parent);
	          	                    });
