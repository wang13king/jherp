...
//					  this.businessType="Financing";
						...
						FundIntent_formulate_editGrid.superclass.constructor
								.call(this, {
									layout:'anchor',
		  					        anchor : '100%',
									items : [
...
//								xtype : 'datecolumn',
								...
								editor : new Ext.form.ComboBox({
								    ...
								    store: new Ext.data.SimpleStore({
										...
										baseParams : {payintentPeriod:typeof(this.object)!='undefined'?this.object.getCmpByName('slSmallloanProject.payintentPeriod').getValue():0}
									}),
								    valueField: 'itemId',
								...
								renderer : function(value, metaData, record, rowIndex,colIndex, store){
									if (record.data.isValid == 1) {
										if(null==record.data.slSuperviseRecordId && record.data.fundType!='principalLending'){
...
//						}
					    ...
					    gridPanel1.getStore().setBaseParam('projectId',projId) ; 
					     gridPanel1.getStore().setBaseParam('slSmallloanProject.accrualtype', accrualtype);debugger
					    ...
					    gridPanel1.getStore().setBaseParam('slSmallloanProject.payintentPeriod', payintentPeriod);
					      ...
					      gridPanel1.getStore().setBaseParam('slSmallloanProject.isPreposePayConsultingCheck', isPreposePayConsultingCheck);
						...
						gridPanel1.getColumnModel().setEditor(6,combox);
