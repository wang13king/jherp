...
synthesizeSlFundIntent = Ext.extend(Ext.Panel, {
	...
	exportExcel:function(){
		...
		if(Q_intentDate_D_GE!=undefined && ""!=Q_intentDate_D_GE){
			
			var d = new Date(Q_intentDate_D_GE);
			Q_intentDate_D_GE =d.getFullYear() + '-' + (d.getMonth() + 1) + '-' + d.getDate() + ' ' + d.getHours() + ':' + d.getMinutes() + ':' + d.getSeconds();
		}
			if(Q_intentDate_D_LE!=undefined && ""!=Q_intentDate_D_LE){
			var d = new Date(Q_intentDate_D_LE);
			Q_intentDate_D_LE =d.getFullYear() + '-' + (d.getMonth() + 1) + '-' + d.getDate() + ' ' + d.getHours() + ':' + d.getMinutes() + ':' + d.getSeconds();
		}
			
		if(endFactDate!=undefined && ""!=endFactDate){
			var d = new Date(endFactDate);
			endFactDate =d.getFullYear() + '-' + (d.getMonth() + 1) + '-' + d.getDate() + ' ' + d.getHours() + ':' + d.getMinutes() + ':' + d.getSeconds();
		}
		if(startFactDate!=undefined && ""!=startFactDate){
			var d = new Date(startFactDate);
			startFactDate =d.getFullYear() + '-' + (d.getMonth() + 1) + '-' + d.getDate() + ' ' + d.getHours() + ':' + d.getMinutes() + ':' + d.getSeconds();
		}
