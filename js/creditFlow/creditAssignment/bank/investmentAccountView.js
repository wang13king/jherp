...
investmentAccountView = Ext.extend(Ext.Panel, {
	...
	initUIComponents : function() {
		...
		var see="";
		if(this.type==1){//线下客户
			if(this.titlePrefix == "线下资金账户查询"){
				see="1";
			}else if(this.titlePrefix == "线下资金账户管理"){
				see="3";
			}
			url = __ctxPath+ "/creditFlow/creditAssignment/bank/systemAccountDownListObSystemAccount.do?isAll="+rightValue+"&isShop="+isShop+"&see="+see
		...
		this.gridPanel = new HT.GridPanel({
					...
					fields : [{
							...
							'totalMoney', 'accountStatus', 'totalInvestMoney','truename',
