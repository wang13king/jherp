withdrawPass = Ext.extend(Ext.Panel, {
	titlePrefix : "",
	seniorHidden : false,
	Confirmhidden : false,
	constructor : function(_cfg) {
		...
		// 调用父类构造
		withdrawPass.superclass.constructor.call(this, {
					id : 'withdrawPass'+this.Type,
					title :"线上提现审核成功",
					region : 'center',
					layout : 'border',
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			...
			rowActions : false,
			isautoLoad:true,
			url : __ctxPath+ "/creditFlow/creditAssignment/bank/withdrawCheckObAccountDealInfo.do?dealRecordStatus=2",
			fields : [{
						name : 'id',
						type : 'int'
