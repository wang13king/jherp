report={
	...
	FinancialProductsModule:[
	                                    __ctxPath + '/js/creditFlow/report/WealthReport/FinancialProductsBuy/FinancialProductsModule.js',
	                                    __ctxPath + '/js/creditFlow/creditAssignment/customer/shop.js'
	                                    ],
	 ...
	 * @type 
	 */
	FinancialProductsShopModule:[
	                                    __ctxPath + '/js/creditFlow/report/WealthReport/FinancialProductsBuy/FinancialProductsShopModule.js'
	                                    ],
	/**
	 * 会员新增明细表
	 * @type 
