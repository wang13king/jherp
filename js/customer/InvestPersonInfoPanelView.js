...
//			url : __ctxPath + '/project/saveSlSmallloanProject.do',
	...
	signContract  :function(){
		...
		var pbar = Ext.MessageBox.wait('生成电子签章中，可能需要较长时间，请耐心等待...','请等待',{
			interval:200,
		    increment:15
		});
		Ext.Ajax.request({
			url : __ctxPath+'/contract/makeSignBiderProduceHelper.do?bidPlanId='+bidPlanId,
			method : 'POST',
			timeout:1800000,
			scope : this,
