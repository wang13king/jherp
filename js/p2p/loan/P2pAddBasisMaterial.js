					  ...
					  var pwindow=this.ownerCt.ownerCt.ownerCt;
					   ...
					   formPanel.getForm().submit({
							...
							success : function(form ,action) {
								...
								if(extendname==".jpg" || extendname==".jpeg" || extendname==".JPG" || extendname==".JPEG"|| extendname==".png"|| extendname==".PNG"){
...
P2pAddBasisMaterial = Ext.extend(Ext.Window, {
		...
		if (this.materialId != null && this.materialId != 'undefined') {
			...
			this.outPanel.loadData({
				...
				success : function(response, options) {
				    ...
				    if(null!=obj.data.shilitu1ExtendName){debugger
			                   	var display =this.getCmpByName('shilitu1');
								if(obj.data.shilitu1ExtendName==".jpg" ||obj.data.shilitu1ExtendName==".png"  || obj.data.shilitu1ExtendName==".PNG" || obj.data.shilitu1ExtendName==".jpeg"|| extendname==".png"|| extendname==".PNG"){
					...
					if(null!=obj.data.shilitu2ExtendName){
								...
								if(obj.data.shilitu2ExtendName==".jpg"   ||obj.data.shilitu1ExtendName==".png"  || obj.data.shilitu1ExtendName==".PNG" || obj.data.shilitu2ExtendName==".jpeg"|| extendname==".png"|| extendname==".PNG"){
	...
	reset : function() {
		   	var display =this.getCmpByName('shilitu1');
		   	display.setText('<div style="width:144px; height:84px; margin:10px 0px 0px 20px; padding:1px 1px 1px 1px;"><img src="'
											+ getRootPath()
											+ '/images/nopic.jpg" width =140 height=80/></div>',false);
		   	var display1 =this.getCmpByName('shilitu2');
		   	display1.setText('<div style="width:144px; height:84px; margin:10px 0px 0px 20px; padding:1px 1px 1px 1px;"><img src="'
											+ getRootPath()
											+ '/images/nopic.jpg" width =140 height=80/></div>',false);
