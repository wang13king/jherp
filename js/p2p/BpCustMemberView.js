...
BpCustMemberView = Ext.extend(Ext.Panel, {
			...
			initUIComponents : function() {
				...
				this.topbar = new Ext.Toolbar({
						items : [ {
									...
									xtype : 'button',
									scope:this,
									handler : this.automaticRecharge
								}]
				});
			...
			automaticRecharge : function() {
					Ext.Ajax.request({
						url : __ctxPath + '/p2p/automaticRechargeBpCustMember.do',
						method : 'POST',
						scope:this,
						success :function(response, request){
					//		var obj = Ext.util.JSON.decode(response.responseText);
						...
						/*	var respText = response.responseText;
							...
							//Ext.ux.Toast.msg('操作信息', alarm_fields.msg);
//							flashPanel.getStore().reload();
						}
			       })
						},
