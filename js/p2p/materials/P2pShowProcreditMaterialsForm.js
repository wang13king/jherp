 ...
 * @author 
 * @createtime 
 * @class P2pShowProcreditMaterialsForm
 * @extends Ext.Window
 * @description SlProcreditMaterials表单
 * @company 智维软件
 */
P2pShowProcreditMaterialsForm = Ext.extend(Ext.Window, {
	        projId:null,
	        operateObj:null,
	        extPanel:null,
	        isShow:false,
			...
			constructor : function(_cfg) {
				...
				P2pShowProcreditMaterialsForm.superclass.constructor.call(this, {
							layout : 'fit',
							modal : true,
							height : 400,
							items : this.extPanel,
			...
			initUIComponents : function() {
				       var root = new Ext.tree.AsyncTreeNode({
					    ...
					    var  url=__ctxPath + '/p2pMaterials/listTree1PlWebShowMaterials.do';
					   if(this.isDelete){
					   	url=__ctxPath + '/p2pMaterials/listExitTreePlWebShowMaterials.do';
					   }
					    ...
					    this.extPanel.on('checkchange', function(node, checked) {debugger 
								/**
								 * 
								 node.expand();  
			...
			save : function() {
			   var panel=this;
			    ...
			    result=result.substring(0,result.length-1)
			     var url=__ctxPath + '/p2pMaterials/updateMaterialsPlWebShowMaterials.do'
