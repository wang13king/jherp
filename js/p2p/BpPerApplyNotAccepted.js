 ...
 * @createtime:
 */
BpPerApplyNotAccepted = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				BpPerApplyNotAccepted.superclass.constructor.call(this, {
							id : 'BpPerApplyNotAccepted',
							title : '未受理申请管理',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel = new HT.GridPanel({
					...
					url : __ctxPath + "/p2p/listBpFinanceApply.do?state=0",//?ck=1&state=0
					fields : [{
								name : 'loanId',
								type : 'int'
