					...
					title : '平台披露数据',
					  items : [{
						...
						items : [{
						       ...
						       listeners : {
							         ...
							         change  :function(nf) {
								        var value= nf.getValue();
								         {
									      nf.setValue(Ext.util.Format.number(value,'0,000.00'))
									      this.getCmpByName("platDataPublish.onLoneMoney3").setValue(value);
								         }
							       }
					             }
					           },{
					          xtype : "hidden",
						      name : "platDataPublish.onLoneMoney3"
					          }]
				            },{
							    columnWidth : .1, // 该列在整行中所占的百分比
								layout : "form", // 从上往下的布局
					         ...
					         items:[{
						       xtype : 'textfield',
						       fieldLabel : '最大单户借款余额占比(近3月)',
						       name : 'platDataPublish.oneOnloanProportion3',
						       maxLength : 100,
						       allowNegative: false, // 允许负数 
					           style: {imeMode:'disabled'},
						       blankText : "金额不能为空，请正确填写!",
					         ...
					         items:[{
						       xtype : 'textfield',
						       fieldLabel : '最大10户借款余额占比(近3月)',
						       name : 'platDataPublish.tenOnloanProportion3',
						       maxLength : 100,
						       allowNegative: false, // 允许负数 
					           style: {imeMode:'disabled'},
						       blankText : "金额不能为空，请正确填写!",
					         ...
					         items:[{
						       xtype : 'textfield',
						       fieldLabel : '借款人数量(近3月)',
						       name : 'platDataPublish.borrowerCount3',
						       maxLength : 100,
						       allowNegative: false, // 允许负数 
					           style: {imeMode:'disabled'},
						       blankText : "金额不能为空，请正确填写!",
					         ...
					         items:[{
											fieldLabel:'平台运营开始时间',
											name : 'platDataPublish.safeOperationTime',
											flex:1,
											align:'center',
											xtype:'datefield',
											format:'Y-m-d',
