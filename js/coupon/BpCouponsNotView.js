...
BpCouponsNotView = Ext.extend(Ext.Panel, {
			title:"",
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				BpCouponsNotView.superclass.constructor.call(this, {
							id : 'BpCouponsNotView',
							title : "未派发",
							region : 'center',
							layout : 'border',
...
//					sm : this.projectFundsm,
					...
					// 使用RowActions
					rowActions : false,
					id : 'BpCouponSettingGrid0',
					url : __ctxPath + "/coupon/listBpCouponSetting.do?Q_couponState_SN_EQ=10&Q_setType_L_EQ=2",
					fields : [ {
									name : 'categoryId',
									type : 'int'
								}
							...
							,'couponCheckUserId','couponState','createDate','createName','createUserId','companyId','setType','counponSumCount','totalSumCouponValue','startMoney'],
					columns : [{
								header : 'categoryId',
