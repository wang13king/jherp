 ...
 * @company 智维软件
 */
BpActivityManageForm = Ext.extend(Ext.Window, {
	// 构造函数
	activityLabel : '',
	label1 : '',
	label2 : '',
	...
	constructor : function(_cfg) {
		...
		BpActivityManageForm.superclass.constructor.call(this, {
					id : 'BpActivityManageFormWin_' + this.type,
					layout : 'fit',
			...
			this.formPanel.getForm().submit({
				...
				success : function(response, request) {
					...
					if(obj.flag){
						...
						Ext.getCmp('BpActivityManageFormWin_'+type).close();
					}
