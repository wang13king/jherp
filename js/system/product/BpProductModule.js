									...
									listeners : {
										...
										check : function(obj, checked) {
											...
											if (flag == true) {
												...
												Ext.getCmp("isPreposePayAccrualCheck").setDisabled(true);
												Ext.getCmp("isInterestByOneTimeCheck").setDisabled(true);
									...
									listeners : {
										...
										check : function(obj, checked) {
											...
											if (flag == true) {
												...
												Ext.getCmp("meiqihkrq1"+this.defination+this.productId).setDisabled(false);
												Ext.getCmp("meiqihkrq2"+this.defination+this.productId).setDisabled(false);
													Ext.getCmp("isPreposePayAccrualCheck").setDisabled(false);
												Ext.getCmp("isInterestByOneTimeCheck").setDisabled(false);
											}
										}
									}
								}, {
								...
								items : [{
									...
									listeners : {
										...
										'blur' : function(nf) {
											...
											dayAccrualRate.setValue(nf.getValue()/ 365);
										}
									}
								}]
							}, {
								...
								items : [{
									...
									listeners : {
										...
										'blur' : function(nf) {
											...
											dayAccrualRate.setValue(nf.getValue()/ 30.41666666666667);
										}
									}
								}]
							}, {
								...
								items : [{
									...
									listeners : {
										...
										'blur' : function(nf) {
											...
											var yearAccrualRate = this.getCmpByName('bpProductParameter.yearAccrualRate')
											var payintentPeriod = this.getCmpByName('bpProductParameter.payintentPeriod');
											yearAccrualRate.setValue(nf.getValue()* 365);
											accrualmonth.setValue(nf.getValue()* 30.416666666666668);
										}
									}
								}]
							}, {
								...
								items : [{
									...
									listeners : {
										...
										'change' : function(nf) {
											...
											dayAccrualRatenf.setValue(nf.getValue()/ 30.416666666666668);
										}
									}
								...
								items : [{
									...
									listeners : {
										...
										'change' : function(nf) {
											...
											accrualnf.setValue(nf.getValue()* 30.416666666666668);
										}
									}
								}]
							}, {
