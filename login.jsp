...
<html xmlns="http://www.w3.org/1999/xhtml" style='background-color: #21272a!important'>
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/ext3/ext-lang-zh_CN.js"></script>
	 	...
	 	<script type="text/javascript" src="<%=request.getContextPath()%>/js/canvas-particle.js"></script>
	...
	<body onkeydown="BindEnter(event)" >
		...
		<div id="mydiv" style="height:521px;padding: 0px; margin: 0px;position: fixed; top: 0px; left: 0px; z-index: -1"></div>
			<div class="logindiv">
		        <div class="loginleft">
		            <h2>业务系统</h2>
		            <div class="login_c_d">
